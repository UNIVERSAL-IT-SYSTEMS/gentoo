...
IUSE="alsa cups derby doc +fontconfig headless-awt javafx jce nsplugin pax_kernel selinux source"
...
src_prepare() {
	if use jce ; then
		cp lib/security/unlimited_policy/*.jar lib/security/ || die
	fi
