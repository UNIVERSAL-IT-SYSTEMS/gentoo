...
*|*_p*)
	MY_PV=${PV/_p/_r}
	SRC_URI="https://github.com/xbmc/xbmc/archive/${PV}-${CODENAME}.tar.gz -> ${P}.tar.gz"
	KEYWORDS="~amd64 ~x86"
...
# need java - there is no generated-addons for available for 16.1
REQUIRED_USE="
	|| ( gles opengl )
	gles? ( !vaapi )
	vaapi? ( !gles )
...
src_prepare() {
	...
	local d dirs=(
		...
		tools/depends/native/JsonSchemaBuilder/src/configure
